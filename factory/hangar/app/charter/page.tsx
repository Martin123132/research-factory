...
const domainCopy: Record<string, string> = {
  ...
  MEMORY: "Negative and shift memory is append-only and searchable. A universal correction and retraction contract remains unfinished.",
    ...
    <>
      ...
      <section className="section-block charter-gap-panel">
        <div>
          ...
          <p>
            It still needs a closed agent dispatch budget, universal correction records,
