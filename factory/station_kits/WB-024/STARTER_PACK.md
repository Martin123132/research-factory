# WB-024 starter-pack envelope

## Catalogue brief

Reproduce the pinned baseline, pass the public verifier, then submit one sealed candidate against hidden holdouts.

## Current status

`BRIEF_ONLY` — This catalogue sentence is only a generic design placeholder; it is not a runnable exercise.
